      ...
      <div className="max-w-[1120px] mx-auto px-8 xl:pl-16 xl:pr-0">
        <h1 className="font-sans font-bold text-[2rem] sm:text-[3rem] md:text-[3.5rem] lg:text-[4rem] leading-[1.3]">
          <div>
            ...
            <span className="animate-fade-in-6 opacity-0 font-serif font-normal text-zinc-400">
          ...
          <div className="my-8 sm:my-16">
            <span className="animate-fade-in-3 opacity-0">I make</span>{' '}
            <span className="animate-fade-in-6 opacity-0 font-serif font-normal text-zinc-400">
              cool and expressive
            </span>{' '}
            ...
            <span className="animate-fade-in-5 opacity-0">
              my social media below.
            </span>
          </div>
        </h1>
        <div className="animate-fade-in-6 opacity-0 mb-8 sm:mb-16 flex flex-col flex-nowrap font-serif font-normal italic text-zinc-400 text-[1.5rem] sm:text-[2rem] md:text-[2.5rem] lg:text-[3.5rem] leading-[1]">
          <a
